...
def main(h5ad_file, organism):
    ...
    adata.uns["DeepScence"] = (
        "Qu Y, Ji B, Dong R, et al. Single-cell and spatial detection of senescent cells using DeepScence. Preprint. bioRxiv. 2025;2023.11.21.568150. Published 2025 Apr 23. doi:10.1101/2023.11.21.568150"
    )
